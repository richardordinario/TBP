            ...
            <div class="overlay">
                                ...
                                <v-flex xs12 lg6 md6 sm6>
                                    <div class="header-title" :class="{'headerPadding': !$vuetify.breakpoint.sm}">
                                        ...
                                        <div class="ml-5">
                                            ...
                                            white--text 
                                            mt-5">VIRTUAL TOUR</p>
                                            <p class="subtitle-1 white--text pa-2">Click the<span icon> <v-icon color="warning">mdi-map-marker</v-icon> </span> icon to discover the wonders of region</p>
                                        </div>
                                    </div>
                                    <v-card
                                    style="
             ...
             <!-- <v-fab-transition>
                ...
                >
                    ...
                    @dragstart="dragStart"
                    @dragend="dragEnd" 
                    color="warning">mdi-map-marker</v-icon>
                </v-btn>
            </v-fab-transition> -->
            <v-speed-dial
